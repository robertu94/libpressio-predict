...
list5m=[]
list5m2=[]
with open('zfp_testSCALE.csv','w',newline='') as csvfile:
    ...
    writer.writeheader()
    i=0
    dimension=numpy.fromfile("/home/vmalvos/datasets/SCALE_98x1200x1200/V-98x1200x1200.dat",dtype=numpy.float32).shape
    print(dimension)
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","V-98x1200x1200.dat","-z","V-98x1200x1200.dat.zfp","-1","141120000","-f","-a","0.00995761"],capture_output=True,text=True)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","V-98x1200x1200.dat.zfp","-o","V-98x1200x1200.dat.dec","-1","141120000","-f","-a","0.00995761"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        p=re.search('Decompression Time: (\d.+)',process.stdout)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","V-98x1200x1200.dat","-z","V-98x1200x1200.dat.zfp","-1","141120000","-f","-a","0.995761"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('Compression time: (\d.+)',process.stdout)
        o=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","V-98x1200x1200.dat.zfp","-o","V-98x1200x1200.dat.dec","-1","141120000","-f","-a","0.995761"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        p=re.search('Decompression Time: (\d.+)',process.stdout)
        q=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","V-98x1200x1200.dat","-z","V-98x1200x1200.dat.zfp","-1","141120000","-f","-a","1.991522"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('Compression time: (\d.+)',process.stdout)
        o=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","V-98x1200x1200.dat.zfp","-o","V-98x1200x1200.dat.dec","-1","141120000","-f","-a","1.991522"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        p=re.search('Decompression Time: (\d.+)',process.stdout)
        q=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","V-98x1200x1200.dat","-z","V-98x1200x1200.dat.zfp","-1","141120000","-f","-a","4.978805"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('Compression time: (\d.+)',process.stdout)
        o=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","V-98x1200x1200.dat.zfp","-o","V-98x1200x1200.dat.dec","-1","141120000","-f","-a","4.978805"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        p=re.search('Decompression Time: (\d.+)',process.stdout)
        q=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","V-98x1200x1200.dat","-z","V-98x1200x1200.dat.zfp","-1","141120000","-f","-a","29.87283"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('Compression time: (\d.+)',process.stdout)
        o=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","V-98x1200x1200.dat.zfp","-o","V-98x1200x1200.dat.dec","-1","141120000","-f","-a","29.87283"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        p=re.search('Decompression Time: (\d.+)',process.stdout)
        q=re.search('(\d+)maxresident',process.stderr)
