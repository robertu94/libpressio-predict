...
list5d=[]
list5m=[]
with open('zfp_libpressio.csv','w',newline='') as csvfile:
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","CLOUDf44.bin","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=0.000000227631"],capture_output=True,text=True)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","CLOUDf44.bin","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=0.0000227631"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('time:compress_many <uint32> = (\d+)',process.stderr)
        p=re.search('time:decompress_many <uint32> = (\d+)',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","CLOUDf44.bin","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=0.00004553"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('time:compress_many <uint32> = (\d+)',process.stderr)
        p=re.search('time:decompress_many <uint32> = (\d+)',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","CLOUDf44.bin","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=0.00011382"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('time:compress_many <uint32> = (\d+)',process.stderr)
        p=re.search('time:decompress_many <uint32> = (\d+)',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","CLOUDf44.bin","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=0.00068289"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('time:compress_many <uint32> = (\d+)',process.stderr)
        p=re.search('time:decompress_many <uint32> = (\d+)',process.stderr)
