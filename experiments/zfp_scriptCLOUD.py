...
list5m=[]
list5m2=[]
with open('zfp_testCLOUDf44.csv','w',newline='') as csvfile:
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","CLOUDf44.bin","-z","CLOUDf44.zfp","-3","100","500","500","-f","-a","0.000000227631"],capture_output=True,text=True)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","CLOUDf44.zfp","-o","CLOUDf44.dec","-3","100","500","500","-f","-a","0.000000227631"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","CLOUDf44.bin","-z","CLOUDf44.zfp","-3","100","500","500","-f","-a","0.0000227631"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('Compression time: (\d.+)',process.stdout)
        o=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","CLOUDf44.zfp","-o","CLOUDf44.dec","-3","100","500","500","-f","-a","0.0000227631"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        p=re.search('Decompression Time: (\d.+)',process.stdout)
        q=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","CLOUDf44.bin","-z","CLOUDf44.zfp","-3","100","500","500","-f","-a","0.00004553"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('Compression time: (\d.+)',process.stdout)
        o=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","CLOUDf44.zfp","-o","CLOUDf44.dec","-3","100","500","500","-f","-a","0.00004553"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        p=re.search('Decompression Time: (\d.+)',process.stdout)
        q=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","CLOUDf44.bin","-z","CLOUDf44.zfp","-3","100","500","500","-f","-a","0.00011382"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('Compression time: (\d.+)',process.stdout)
        o=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","CLOUDf44.zfp","-o","CLOUDf44.dec","-3","100","500","500","-f","-a","0.00011382"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        p=re.search('Decompression Time: (\d.+)',process.stdout)
        q=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-i","CLOUDf44.bin","-z","CLOUDf44.zfp","-3","100","500","500","-f","-a","0.00068289"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('Compression time: (\d.+)',process.stdout)
        o=re.search('(\d+)maxresident',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","zfp","-z","CLOUDf44.zfp","-o","CLOUDf44.dec","-3","100","500","500","-f","-a","0.00068289"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        p=re.search('Decompression Time: (\d.+)',process.stdout)
        q=re.search('(\d+)maxresident',process.stderr)
