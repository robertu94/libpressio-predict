...
list5d=[]
list5m=[]
with open('zfp_libpressiohacc.csv','w',newline='') as csvfile:
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","vx.f32","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=0.690875"],capture_output=True,text=True)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","vx.f32","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=69.0875"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('time:compress_many <uint32> = (\d+)',process.stderr)
        p=re.search('time:decompress_many <uint32> = (\d+)',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","vx.f32","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=138.175"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('time:compress_many <uint32> = (\d+)',process.stderr)
        p=re.search('time:decompress_many <uint32> = (\d+)',process.stderr)
    ...
    i=0 
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","vx.f32","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=345.4375"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('time:compress_many <uint32> = (\d+)',process.stderr)
        p=re.search('time:decompress_many <uint32> = (\d+)',process.stderr)
    ...
    i=0
    while i<30:
        process=subprocess.run(["/usr/bin/time","pressio","-i","vx.f32","-m","time","-M","all","-d","500","-d","500","-d","100","-t","float","zfp","-o","zfp:accuracy=2072.625"],capture_output=True,text=True)
        print(process.stdout)
        print(process.stderr)
        m=re.search('time:compress_many <uint32> = (\d+)',process.stderr)
        p=re.search('time:decompress_many <uint32> = (\d+)',process.stderr)
